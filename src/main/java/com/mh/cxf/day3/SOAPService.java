 ...
 * 2014-11-15T19:41:56.141+08:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "SOAPService", 
                  wsdlLocation = "/Users/jasonyao/project/workspace_list/biyesheji/ApacheCXFDemo/src/main/java/com/mh/cxf/day3/HelloWorld.wsdl",
...
public class SOAPService extends Service {
    ...
    static {
        URL url = SOAPService.class.getResource("/Users/jasonyao/project/workspace_list/biyesheji/ApacheCXFDemo/src/main/java/com/mh/cxf/day3/HelloWorld.wsdl");
        if (url == null) {
            url = SOAPService.class.getClassLoader().getResource("/Users/jasonyao/project/workspace_list/biyesheji/ApacheCXFDemo/src/main/java/com/mh/cxf/day3/HelloWorld.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(SOAPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/Users/jasonyao/project/workspace_list/biyesheji/ApacheCXFDemo/src/main/java/com/mh/cxf/day3/HelloWorld.wsdl");
        }       
        WSDL_LOCATION = url;
    }
